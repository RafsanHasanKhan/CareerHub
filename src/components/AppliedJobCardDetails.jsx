...
const AppliedJobCardDetails = () => {
  const { id } = useParams()
  const dataLoad = useLoaderData()
  const [data, setData] = useState([])

  useEffect(() => {
    const findData = dataLoad.find(d => d.id === parseFloat(id));
    setData(findData)
  }, [data])
  ...
  return (
    <div>
      <div className="relative bg-primary-gradient pt-48 pb-36 text-center">
        <h1 className="text-3xl font-extrabold">Applied Jobs Details</h1>
        <img
...
export default AppliedJobCardDetails;